...
If you have any crypto holdings on another platform currently, either transfer them out or sell them to dollars BEFORE going through this setup process!
...
## Step 5 — Set your folder, coins, and Phemex keys (inside the Hub)
...
- **While you are still in Settings**, click **Phemex (CCXT) API Setup** and do this:

1. Create a **Phemex API Key + Secret** in your Phemex account (enable trading if you plan to trade).
...
`ccxt_key.txt` and `ccxt_secret.txt`  
Keep them private.
